...
#as with numbers, you create an array of the target len +1
#for can construct you only need them to be boolen
#for all values, you seed the first value with list of list
#for each idx, iterate through each word and check if the word begins with character of target indx.
#if so, copy the value of dp of i and append the word into it, but place it len(word) + idx 
